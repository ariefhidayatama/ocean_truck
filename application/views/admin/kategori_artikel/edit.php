  ...
  <section class="col-lg-12 connectedSortable">
    ...
    <div class="box box-info">
      <div class="box-header">
        ...
        // open form
        echo form_open('admin/kategori_artikel/edit/'.$detail->id);  
        ?>
        <div class="box-body">
          <div class="form-group">
            <label>Kategori Artikel</label>
            <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" placeholder="Kategori" value="<?= $detail->nama_kategori ?>">
          </div>
          <div class="form-group">
