...
<head>
    ...
    <link rel="apple-touch-icon" href="<?= base_url()?>assets/classic/images/apple-touch-icon.png">
    <link rel="shortcut icon" type="image/ico" href="<?= base_url()?>assets/classic/images/favicon.ico" />
    <!-- Plugin-CSS -->
    <link rel="stylesheet" href="<?= base_url()?>assets/classic/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/classic/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/classic/css/icofont.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/classic/css/magnific-popup.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/classic/css/animate.css">
    <!-- Main-Stylesheets -->
    <link rel="stylesheet" href="<?= base_url()?>assets/classic/css/normalize.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/classic/style.css">
    <link rel="stylesheet" href="<?= base_url()?>assets/classic/css/responsive.css">
    <script src="<?= base_url()?>assets/classic/js/vendor/modernizr-2.8.3.min.js"></script>
...
<body data-spy="scroll" data-target=".mainmenu-area">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="navbar-header smoth">
                        ...
                        <a class="navbar-brand" href="<?= base_url()?>assets/classic/#home-area"><img src="<?= base_url()?>assets/classic/images/logo.png" alt=""></a>
                    </div>
                    <div class="collapse navbar-collapse navbar-right" id="mainmenu">
                        <ul class="nav navbar-nav navbar-right help-menu">
                            <li><a href="<?= base_url()?>assets/classic/"><i class="icofont icofont-user-alt-4"></i></a></li>
                            <li><a href="<?= base_url()?>assets/classic/#search-box" data-toggle="collapse"><i class="icofont icofont-search-alt-2"></i></a></li>
                        ...
                        <ul class="nav navbar-nav primary-menu">
                            <li class="active"><a href="<?= base_url()?>assets/classic/#home-area">Home</a></li>
                            <li><a href="<?= base_url()?>assets/classic/#service-area">Services</a></li>
                            <li><a href="<?= base_url()?>assets/classic/#portfolio-area">Portfolio</a></li>
                            <li><a href="<?= base_url()?>assets/classic/#team-area">Team</a></li>
                            <li><a href="<?= base_url()?>assets/classic/#price-area">Price</a></li>
                            <li><a href="<?= base_url()?>assets/classic/#blog-area">Blog</a></li>
                            <li><a href="<?= base_url()?>assets/classic/#contact-area">Contact</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xs-12 col-sm-10 col-md-8">
                        <div class="header-text">
                            ...
                            <div class="wow fadeInUp" data-wow-delay="0.7s">
                                <a href="<?= base_url()?>assets/classic/#" class="bttn bttn-lg bttn-primary">Contact Now</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-5">
                    ...
                    <div class="wow fadeInUp" data-wow-delay="0.7s">
                        <a href="<?= base_url()?>assets/classic/#" class="bttn bttn-primary">Learn More</a>
                    </div>
                </div>
                <div class="hidden-xs col-sm-6 col-md-offset-1">
                    <img src="<?= base_url()?>assets/classic/images/about-image.png" alt="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-6">
                    <div class="video-box">
                        <img src="<?= base_url()?>assets/classic/images/video-image.png" alt="">
                        <a href="<?= base_url()?>assets/classic/https://www.youtube.com/watch?v=7e90gBu4pas" class="video-bttn"><img src="<?= base_url()?>assets/classic/images/video-button.png" alt=""></a>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-6 col-md-5 col-md-offset-1 wow fadeInUp">
                    <div class="page-title">
                        ...
                        <ul class="tabs-list">
                            <li class="active"><a data-toggle="pill" href="<?= base_url()?>assets/classic/#our_mission">Our Mission</a></li>
                            <li><a data-toggle="pill" href="<?= base_url()?>assets/classic/#our_vission">Our Vission</a></li>
                            <li><a data-toggle="pill" href="<?= base_url()?>assets/classic/#our_support">Our Support</a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div id="our_mission" class="tab-pane fade in active">
                            ...
                            <br />
                            <a href="<?= base_url()?>assets/classic/#" class="bttn bttn-sm bttn-primary">View More</a>
                        </div>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-4">
                    <div class="feature-box wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <a href="<?= base_url()?>assets/classic/#" class="read-more">Read More</a>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-4">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-offset-1">
                    <img src="<?= base_url()?>assets/classic/images/skill-image.png" alt="">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="filtering">
                <div class="col-xs-6 col-sm-4 col-md-3 mix graphics developing">
                    <div class="filter-box">
                        <div class="filter-image">
                            <img src="<?= base_url()?>assets/classic/images/work-1.jpg" alt="">
                        </div>
                        <div class="filter-hover">
                            <h5>Print Template</h5>
                            <a href="<?= base_url()?>assets/classic/images/work-1.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-3 mix ux_ui ">
                    <div class="filter-box">
                        <div class="filter-image">
                            <img src="<?= base_url()?>assets/classic/images/work-2.jpg" alt="">
                        </div>
                        <div class="filter-hover">
                            <h5>Graphics Template</h5>
                            <a href="<?= base_url()?>assets/classic/images/work-2.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-3 mix graphics ">
                    <div class="filter-box">
                        <div class="filter-image">
                            <img src="<?= base_url()?>assets/classic/images/work-3.jpg" alt="">
                        </div>
                        <div class="filter-hover">
                            <h5>Web Template</h5>
                            <a href="<?= base_url()?>assets/classic/images/work-3.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-3 mix ux_ui developing">
                    <div class="filter-box">
                        <div class="filter-image">
                            <img src="<?= base_url()?>assets/classic/images/work-4.jpg" alt="">
                        </div>
                        <div class="filter-hover">
                            <h5>Developing</h5>
                            <a href="<?= base_url()?>assets/classic/images/work-4.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-3 mix web_design photography">
                    <div class="filter-box">
                        <div class="filter-image">
                            <img src="<?= base_url()?>assets/classic/images/work-5.jpg" alt="">
                        </div>
                        <div class="filter-hover">
                            <h5>Photography</h5>
                            <a href="<?= base_url()?>assets/classic/images/work-5.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-3 mix coding">
                    <div class="filter-box">
                        <div class="filter-image">
                            <img src="<?= base_url()?>assets/classic/images/work-6.jpg" alt="">
                        </div>
                        <div class="filter-hover">
                            <h5>Coding</h5>
                            <a href="<?= base_url()?>assets/classic/images/work-6.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-3 mix web_design developing">
                    <div class="filter-box">
                        <div class="filter-image">
                            <img src="<?= base_url()?>assets/classic/images/work-7.jpg" alt="">
                        </div>
                        <div class="filter-hover">
                            <h5>Web Desing</h5>
                            <a href="<?= base_url()?>assets/classic/images/work-7.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-3 mix coding photography">
                    <div class="filter-box">
                        <div class="filter-image">
                            <img src="<?= base_url()?>assets/classic/images/work-8.jpg" alt="">
                        </div>
                        <div class="filter-hover">
                            <h5>Coding</h5>
                            <a href="<?= base_url()?>assets/classic/images/work-8.jpg" class="filter-popup" data-effect="mfp-zoom-in"></a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="team-box wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-image">
                            <img src="<?= base_url()?>assets/classic/images/team-1.jpg" alt="">
                        </div>
                        <div class="team-hover">
                            ...
                            <div class="team-social-menu">
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-facebook"></i></a>
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-twitter"></i></a>
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-linkedin"></i></a>
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-pinterest"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="team-box wow fadeInUp" data-wow-delay="0.4s">
                        <div class="team-image">
                            <img src="<?= base_url()?>assets/classic/images/team-2.jpg" alt="">
                        </div>
                        <div class="team-hover">
                ...
                <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="team-box wow fadeInUp" data-wow-delay="0.6s">
                        <div class="team-image">
                            <img src="<?= base_url()?>assets/classic/images/team-3.jpg" alt="">
                        </div>
                        <div class="team-hover">
                ...
                <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="team-box wow fadeInUp" data-wow-delay="0.8s">
                        <div class="team-image">
                            <img src="<?= base_url()?>assets/classic/images/team-4.jpg" alt="">
                        </div>
                        <div class="team-hover">
    ...
    <section class="section-padding gray-bg" id="price-area">
        <div class="container">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <ul class="price-tabs">
                        <li class="active"><a data-toggle="pill" href="<?= base_url()?>assets/classic/#monthly">Monthly</a></li>
                        <li><a data-toggle="pill" href="<?= base_url()?>assets/classic/#yearly">Yearly</a></li>
                    </ul>
                </div>
            </div>
                ...
                <div id="monthly" class="tab-pane fade in active">
                    <div class="col-xs-6 col-md-3 wow fadeInLeft" data-wow-delay="0.2s">
                        <div class="price-box">
                            ...
                            <a href="<?= base_url()?>assets/classic/#" class="bttn bttn-sm bttn-default">Purchase Now</a>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-md-6 wow fadeInUp">
                    <div class="blog-box">
                        <div class="blog-image">
                            <img src="<?= base_url()?>assets/classic/images/blog-md-1.jpg" alt="">
                        </div>
                        <div class="blog-details">
                            <h4><a href="<?= base_url()?>assets/classic/#">Business Consultance Meetup, 10 Jan, 2016</a></h4>
                    ...
                    <div class="blog-lists">
                        <div class="blog-list wow fadeInUp" data-wow-delay="0.2s">
                            <div class="blog-list-image">
                                <img src="<?= base_url()?>assets/classic/images/blog-th-1.jpg" alt="">
                            </div>
                            <h5><a href="<?= base_url()?>assets/classic/#">On Graphics Design Post</a></h5>
                        ...
                        <div class="blog-list wow fadeInUp" data-wow-delay="0.4s">
                            <div class="blog-list-image">
                                <img src="<?= base_url()?>assets/classic/images/blog-th-2.jpg" alt="">
                            </div>
                            <h5><a href="<?= base_url()?>assets/classic/#">On Graphics Design Post</a></h5>
                            <div class="blog-list-meta"> <i class="icofont icofont-ui-calendar"></i> 16 JUNE 2016</div>
                            <p>It is a long established fact that a reader will be distracted by the readable content.</p>
                        ...
                        <div class="blog-list wow fadeInUp" data-wow-delay="0.6s">
                            <div class="blog-list-image">
                                <img src="<?= base_url()?>assets/classic/images/blog-th-3.jpg" alt="">
                            </div>
                            <h5><a href="<?= base_url()?>assets/classic/#">On Graphics Design Post</a></h5>
                            <div class="blog-list-meta"> <i class="icofont icofont-ui-calendar"></i> 16 JUNE 2016</div>
                            <p>It is a long established fact that a reader will be distracted by the readable content.</p>
                    ...
                    <div class="col-xs-12 col-md-4">
                        <div class="contact-info">
                            ...
                            <div class="social-menu-2">
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-twitter"></i></a>
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-skype"></i></a>
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-instagram"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-3">
                        <div class="footer-text">
                            ...
                            <div class="social-menu">
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-facebook"></i></a>
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-twitter"></i></a>
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-google-plus"></i></a>
                                <a href="<?= base_url()?>assets/classic/#"><i class="icofont icofont-social-linkedin"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-2 col-md-offset-1">
                        <div class="footer-single">
                            ...
                            <ul>
                                <li><a href="<?= base_url()?>assets/classic/#">Subsciption</a></li>
                                <li><a href="<?= base_url()?>assets/classic/#">New Apps</a></li>
                                <li><a href="<?= base_url()?>assets/classic/#">Download now</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-2">
                        <div class="footer-single">
                            ...
                            <ul>
                                <li><a href="<?= base_url()?>assets/classic/#">Screenshot</a></li>
                                <li><a href="<?= base_url()?>assets/classic/#">Fetures</a></li>
                                <li><a href="<?= base_url()?>assets/classic/#">Price</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-2">
                        <div class="footer-single">
                            ...
                            <ul>
                                <li><a href="<?= base_url()?>assets/classic/#">Support</a></li>
                                <li><a href="<?= base_url()?>assets/classic/#">Contact</a></li>
                                <li><a href="<?= base_url()?>assets/classic/#">Privacy &amp; Term</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-xs-6 col-md-2">
                        <div class="footer-single">
                            ...
                            <ul>
                                <li><a href="<?= base_url()?>assets/classic/#">Bug Fixing</a></li>
                                <li><a href="<?= base_url()?>assets/classic/#">Upgrade</a></li>
                                <li><a href="<?= base_url()?>assets/classic/#">Malware Protect</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <p class="copyright">Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icofont icofont-heart-alt" aria-hidden="true"></i> by <a href="<?= base_url()?>assets/classic/https://colorlib.com" target="_blank">Colorlib</a></p>
                        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    </div>
                </div>
            </div>
    ...
    <!--Vendor-JS-->
    <script src="<?= base_url()?>assets/classic/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="<?= base_url()?>assets/classic/js/vendor/bootstrap.min.js"></script>
    <!--Plugin-JS-->
    <script src="<?= base_url()?>assets/classic/js/owl.carousel.min.js"></script>
    <script src="<?= base_url()?>assets/classic/js/appear.js"></script>
    <script src="<?= base_url()?>assets/classic/js/bars.js"></script>
    <script src="<?= base_url()?>assets/classic/js/waypoints.min.js"></script>
    <script src="<?= base_url()?>assets/classic/js/counterup.min.js"></script>
    <script src="<?= base_url()?>assets/classic/js/easypiechart.min.js"></script>
    <script src="<?= base_url()?>assets/classic/js/mixitup.min.js"></script>
    <script src="<?= base_url()?>assets/classic/js/contact-form.js"></script>
    <script src="<?= base_url()?>assets/classic/js/scrollUp.min.js"></script>
    <script src="<?= base_url()?>assets/classic/js/magnific-popup.min.js"></script>
    <script src="<?= base_url()?>assets/classic/js/wow.min.js"></script>
    <!--Main-active-JS-->
    <script src="<?= base_url()?>assets/classic/js/main.js"></script>
    <!-- <script async defer src="<?//= base_url()?>assets/classic/https://maps.googleapis.com/maps/api/js?key=AIzaSyDXZ3vJtdK6aKAEWBovZFe4YKj1SGo9V20&callback=initMap"></script> -->
    <script src="<?= base_url()?>assets/classic/js/maps.js"></script>
</body>
